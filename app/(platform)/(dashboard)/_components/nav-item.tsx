...
export function NavItem({ isActive, isExpanded, onExpand, organization }: NavItemProps) {
            ...
            >
                <div className="flex items-center gap-x-2">
                    <div className="w-7 h-7 relative">
                        <Image className="rounded-sm object-cover" src={organization.imageUrl} fill alt="Organization"/>
                    </div>
